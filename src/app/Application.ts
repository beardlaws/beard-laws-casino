...
export class Application {
  ...
  private showMathReport(): void {
    ...
    window.setTimeout(() => {
      ...
      modal.innerHTML = `<div class="atm-modal"><button class="close" data-close>×</button><small>BEARD BANK V33 • 1,000,000 SPINS</small><h2>Verified Complete Math</h2><div class="math-report-grid">
